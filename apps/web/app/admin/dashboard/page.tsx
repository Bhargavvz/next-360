      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { label: 'Pending Certificates', value: '0', icon: '📋' },
            { label: 'GMV', value: '₹0', icon: '💰' },
            { label: 'Open Disputes', value: '0', icon: '⚠️' },
            { label: 'Fraud Alerts', value: '0', icon: '🚨' },
            { label: 'Pending Sellers', value: '0', icon: '⏳' },
          ].map((stat) => (
        ...
        <div className="mt-12 rounded-xl border bg-card p-8 text-center text-muted-foreground">
          <p>Full admin panel coming in Phase 7.</p>
        </div>
      </div>
    </div>
  );
