...
import { Search, ShoppingCart, Heart, Menu, X, ChevronDown, LogOut, User, Package, LayoutDashboard } from 'lucide-react';
      ...
      {mobileOpen && (
        <div className="md:hidden border-t px-4 py-4 space-y-3 bg-background animate-in slide-in-from-top-2">
          ...
          <nav className="flex flex-col gap-1">
            ...
            <Link href="/products?verified=true" onClick={() => setMobileOpen(false)} className="px-3 py-2 text-sm rounded-lg hover:bg-accent text-primary font-medium">✓ Verified Organic</Link>
          </nav>
        </div>
      )}
    </header>
