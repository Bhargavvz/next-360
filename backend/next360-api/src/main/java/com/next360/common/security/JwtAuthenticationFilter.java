 ...
 * and sets the SecurityContext with a UserPrincipal.
 */
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (token != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            claimsOpt.ifPresent(claims -> {
                ...
                String phone = jwtService.getPhoneFromClaims(claims);
                List<UserRole> roles = jwtService.getRolesFromClaims(claims);
